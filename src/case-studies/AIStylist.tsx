...
export default function AIStylist({ onBack = goBack, origin }: Props) {
  useCaseStudyFx();
  ...
  return (
    <motion.div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="AIStylist AI Redesign presentation"
    ...
    >
      <div className="as-topbar">
        ...
        <div className="as-topbar__title">
          <span className="as-topbar__eyebrow">AIStylist · 2025</span>
        ...
        >
          <div className="as-slides__frame">
            <iframe
              ...
              src={FIGMA_SRC}
              title="AIStylist AI Redesign — Figma Slides"
              allowFullScreen
