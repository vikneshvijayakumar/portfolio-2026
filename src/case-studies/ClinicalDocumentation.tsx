                ...
                {module.id === "patient-intake" ? (
                  ...
                  <>
                    ...
                    <div className="cd-media">
                      <img
                        ...
                        src={companionAppImage.src}
                        alt={module.title}
                      />
                      <MaximizeButton
                        onClick={() => setLightboxMedia({ type: "image", src: companionAppImage.src, alt: module.title })}
                      />
                    </div>
                  </>
                  ...
                  <>
                    ...
                    <div className="cd-media">
                      ...
                      />
                      <MaximizeButton
                        onClick={() => setLightboxMedia({ type: "image", src: trainerImage.src, alt: module.title })}
                      />
                    </div>
                  </>
                ) : (
...
export default function ClinicalDocumentation({ onBack = goBack, origin }: Props) {
  useCaseStudyFx();
