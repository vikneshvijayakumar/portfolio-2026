...
export default function Obv3({ onBack = goBack, origin }: Props) {
  useCaseStudyFx();
  ...
  return (
    ...
    >
      <div className="obv3-topbar">
        <a className="obv3-back" href="/" onClick={goBack} aria-label="Back to the portfolio">
