...
export default function PocketStylist({ onBack, origin }: Props) {
  ...
  return (
    <motion.div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="PocketStylist case study"
    ...
    >
      ...
      <div className="ps-topbar">
        ...
        <div className="ps-topbar__title">
          ...
          <span className="ps-topbar__name">PocketStylist Redesign</span>
        </div>
      </div>
          ...
          <div className="ps-hero__inner">
            <div className="ps-hero__main">
              <div className="ps-hero__lede">
                ...
                >
                  Pocket <em>Stylist</em><br />AI Redesign
                </motion.h1>
