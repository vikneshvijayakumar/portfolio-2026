...
import vanakkamBadge from "./assets/vanakkam.webp?url";
...
// Case studies live as their own Astro pages — the canvas navigates to them.
...
function App() {
  ...
  useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      // Escape to close the legend is always allowed
      if (event.key === "Escape") {
  ...
  }, [activeZone, isMobile, isLegendOpen, zoneSequence, setTheme]);
